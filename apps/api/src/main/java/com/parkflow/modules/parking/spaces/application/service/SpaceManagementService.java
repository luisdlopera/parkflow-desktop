...
public class SpaceManagementService implements SpaceManagementUseCase {
  ...
  public ParkingSpaceOccupancySummaryResponse resizeCapacity(UUID companyId, int newCapacity) {
    ...
    // Delegate to query service for summary calculation
    return calculateOccupancySummary(companyId);
  }

  private ParkingSpaceOccupancySummaryResponse calculateOccupancySummary(UUID companyId) {
