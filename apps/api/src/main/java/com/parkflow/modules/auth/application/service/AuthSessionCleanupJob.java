...
import com.parkflow.modules.auth.infrastructure.persistence.AuthSessionRepository;
...
public class AuthSessionCleanupJob {
  ...
  public void purgeExpiredSessions() {
    ...
    long deleted = authSessionRepository.deleteByActiveFalseAndCreatedAtBefore(cutoff);
