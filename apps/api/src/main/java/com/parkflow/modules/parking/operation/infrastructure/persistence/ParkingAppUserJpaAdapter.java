...
@Component("parkingAppUserJpaAdapter")
@RequiredArgsConstructor
public class ParkingAppUserJpaAdapter implements AppUserPort {

  private final ParkingAppUserJpaRepository jpaRepository;
  ...
  @Repository
  interface ParkingAppUserJpaRepository extends JpaRepository<AppUser, UUID> {
