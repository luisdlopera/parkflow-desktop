...
import { useCrashRecovery } from "@/hooks/core/useAutoSave";
...
export function CrashRecoveryDialog({ formKey, onRestore, onDismiss }: CrashRecoveryDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-md">
      <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-default-200 dark:border-zinc-700 p-6 max-w-md w-full mx-4 animate-in zoom-in-95 duration-200">
