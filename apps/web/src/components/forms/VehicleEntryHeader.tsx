...
export default function VehicleEntryHeader({
  ...
  if (isSingleType) {
    return (
      <div className="bg-brand-50/50 dark:bg-brand-900/10 rounded-xl border border-brand-200/30 dark:border-brand-800/30 p-3">
  ...
  return (
    <div className="bg-brand-50/50 dark:bg-brand-900/10 rounded-xl border border-brand-200/30 dark:border-brand-800/30 p-4">
