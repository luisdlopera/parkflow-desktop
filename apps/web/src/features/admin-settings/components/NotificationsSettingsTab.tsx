    ...
    <Card>
      ...
      <Card.Content className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Switch isSelected={settings.emailNotificationsEnabled} onChange={(v) => onUpdate("emailNotificationsEnabled", v)} color="primary" />
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch isSelected={settings.notifyOnBlock} onChange={(v) => onUpdate("notifyOnBlock", v)} />
          </div>
          <div className="flex items-center justify-between">
            <div>
            ...
            <Switch isSelected={settings.notifyOnLicenseExpire} onChange={(v) => onUpdate("notifyOnLicenseExpire", v)} />
          </div>
          <div className="flex items-center justify-between">
            <div>
            ...
            <Switch isSelected={settings.notifyAdminsOnNewCompany} onChange={(v) => onUpdate("notifyAdminsOnNewCompany", v)} />
          </div>
        </div>
      </Card.Content>
    </Card>
