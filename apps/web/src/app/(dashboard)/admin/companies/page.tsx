...
import { useCompanies, useCreateCompany, translatePlan, translateStatus } from "@/lib/licensing/hooks";
          ...
          <CardBody className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold">
                {isLoading ? <Skeleton className="w-8 h-6" /> : companies?.length || 0}
              </p>
            </div>
          </CardBody>
        </Card>
            ...
            <div>
              ...
              <p className="text-xl font-bold">
                {isLoading ? (
                  ...
                  companies?.filter((c) => c.status === "ACTIVE" || c.status === "TRIAL").length || 0
                )}
              </p>
            </div>
          </CardBody>
