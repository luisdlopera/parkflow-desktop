...
export const handlers = [
  ...
  // Cash
  http.post('http://localhost:6011/api/v1/cash/open', () => {
    return HttpResponse.json({
  ...
  http.get('http://localhost:6011/api/v1/cash/current', () => {
    return HttpResponse.json({
      id: '123e4567-e89b-12d3-a456-426614174001',
      status: 'OPEN',
      balance: 0
  ...
  // Licensing - Companies
  http.get('http://localhost:6011/api/v1/licensing/companies', () => {
    return HttpResponse.json([
  ...
  http.post('http://localhost:6011/api/v1/licensing/companies', () => {
    return HttpResponse.json(mockCompany('company-new', { name: 'Nueva Empresa' }), { status: 201 })
  }),

  // Licensing - License generation
  http.post('http://localhost:6011/api/v1/licensing/licenses/generate', () => {
    return HttpResponse.json({
      deviceId: 'device-1',
  ...
  // Licensing - Support
  http.get('http://localhost:6011/api/v1/licensing/support/cases/priority', () => {
    return HttpResponse.json([
  ...
  http.get('http://localhost:6011/api/v1/licensing/support/blocks/unresolved', () => {
    return HttpResponse.json([
  ...
  http.get('http://localhost:6011/api/v1/licensing/support/statistics', () => {
    return HttpResponse.json({
      totalBlocks: 10,
      unresolvedBlocks: 3,
      falsePositives: 1,
  ...
  http.post('http://localhost:6011/api/v1/licensing/support/blocks/:id/resolve', () => {
    return HttpResponse.json({ success: true })
  }),

  http.post('http://localhost:6011/api/v1/licensing/support/blocks/:id/false-positive', () => {
    return HttpResponse.json({ success: true })
  }),

  // Licensing - Audit
  http.get('http://localhost:6011/api/v1/licensing/audit', () => {
    return HttpResponse.json({
      content: [
