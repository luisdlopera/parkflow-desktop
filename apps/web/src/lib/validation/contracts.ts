...
export const settingsRateUpsertSchema = z.object({
  ...
  rateType: z.enum(["HOURLY", "FRACTION", "FRACTIONAL", "DAILY", "FLAT"]),
  ...
  minSessionValue: z.number().min(0).optional().nullable(),
  maxSessionValue: z.number().min(0).optional().nullable(),
  appliesNight: z.boolean().optional(),
  nightSurchargePercent: z.number().min(0).optional(),
  appliesHoliday: z.boolean().optional(),
  holidaySurchargePercent: z.number().min(0).optional(),
  appliesDaysBitmap: z.number().int().min(0).max(127).optional().nullable(),
...
export const settingsParametersSchema = z.object({
  ...
  cashMaxManualAdjustment: z.number().min(0).optional(),
  cashMaxSessionHours: z.number().int().min(0).optional(),
  cashAllowMultipleOpenSessions: z.boolean().optional(),
  cashAllowMultipleSessionsPerUser: z.boolean().optional(),
